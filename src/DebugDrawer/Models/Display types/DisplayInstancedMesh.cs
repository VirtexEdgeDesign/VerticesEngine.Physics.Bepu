...
namespace BEPUphysicsDrawer.Models
{
    ...
    /// </summary>
    public class DisplayInstancedMesh : CustomMesh<InstancedMesh>
    {
        /// <summary>
        ...
        public override void GetMeshData(List<VertexPositionNormalTexture> vertices, List<ushort> indices)
        {
            ...
            for (int i = 0; i < DisplayedObject.Shape.TriangleMesh.Data.Vertices.Length; i++)
            {
                tempVertices[i] = new VertexPositionNormalTexture(
                    (BEPUutilities.AffineTransform.Transform(DisplayedObject.Shape.TriangleMesh.Data.Vertices[i], DisplayedObject.WorldTransform)),
                    Vector3.Zero, 
                    Vector2.Zero);
            }
