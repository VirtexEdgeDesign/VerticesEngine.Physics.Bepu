...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public class CapsuleShape : ConvexShape
    {
...
#endif
            Vector3 upExtreme;
			TransformYFast(halfLength, ref shapeTransform.Orientation, out upExtreme);
		...
		private static void TransformYFast(float y, ref Quaternion rotation, out Vector3 result)
		{
